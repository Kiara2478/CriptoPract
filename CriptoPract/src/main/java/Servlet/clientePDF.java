 ...
 * @author kiara
 */
@WebServlet(name = "clientePDF", urlPatterns = {"/clientePDF"})
public class clientePDF extends HttpServlet {
@Override
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
       ...
       conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/crippractica", "root", ""); // Ajusta tu user y pass
        ...
        String rutaJasper = getServletContext().getRealPath("/WEB-INF/reportes/report1.jasper");
