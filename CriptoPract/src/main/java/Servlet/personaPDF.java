 ...
 * @author kiara
 */
@WebServlet(name = "personaPDF", urlPatterns = {"/personaPDF"})
public class personaPDF extends HttpServlet {
@Override
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
       ...
       conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/crippractica", "root", ""); // Ajusta tu user y pass
        ...
        String rutaJasper = getServletContext().getRealPath("/WEB-INF/reportes/report2.jasper");
